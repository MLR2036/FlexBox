...
public class BoxTypeII extends Box {

	public BoxTypeII(double w, double l, double h) {
		super(w, l, h);
...
//Start of calculateCost
	...
	public double calculateCost(int cardGrade, int numOfColours,
		...
		if(slbTop){			
			double addTop = cost * 0.17;//get the cost of extras plus a top for this type of box
			cost =  (cost + addTop);//add extras plus top cost to cost   			
			return cost;
		}
		else{
			 
			double extras = cost * 0.12;//get the cost of extras without a top for this type of box 
